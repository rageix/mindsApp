...
import FieldFormController, {
  IForm,
} from '@/components/DynamicFormsView/DynamicFormEditor/FieldForm/FieldFormController';
import Checkbox from '@/components/Checkbox';
import { fieldRecord } from '@/types/DynamicForm';
import { PlusIcon } from 'lucide-react';
import FieldOption from '@/components/DynamicFormsView/DynamicFormEditor/FieldForm/FieldOption';
    ...
    <Form onSubmit={controller.onSubmitForm}>
      ...
      <div className="flex items-center">
        <Checkbox<IForm>
          ...
          onChange={controller.onChangeIsEmail}
        />
        <FormLabel<IForm>
          field="isEmail"
          className="ml-3"
