...
export default function Input<T>(props: Props<T>) {
  ...
  return (
    <input
      ...
      {...newProps}
      className={cn(
        'block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 ring-2 ring-gray-300 ring-inset placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm/6 !border-none',
        props.className,
      )}
    />
  );
